                ...
                <td
                  ...
                  className={
                    isDisable(day, slot)
                      ...
                      : `${formCalendar?.slotId === slot.id && formCalendar?.date === moment(day, "MM/DD").format("YYYY-MM-DD") ? "bg-[#CDFAE7]" : ""} border p-1 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-300 ease hover:bg-[#CDFAE7]`
                  }
                >
                </td>
              ))}
