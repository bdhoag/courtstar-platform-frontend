...
import './index.css';
import { CreditCardProps } from './index';

const CreditCard: React.FC<CreditCardProps> = ({ bankName, cardHolderName, number} ) => {
  return (
    <div className='credit-card flex justify-center items-center'>
      <div className="flip-card">
        <div className="flip-card-inner">
          <div className="flip-card-front">
              <p className="heading_8264">COURTSTAR</p>
              <img src="/favicon.svg" alt="favicon" className='logo w-8'/>
              ...
              <p className="number">{number?.replace(/(\d{4})(?=\d)/g, '$1 ')}</p>
              <p className="absolute bottom-9 text-xs left-[15px] uppercase">{cardHolderName}</p>
