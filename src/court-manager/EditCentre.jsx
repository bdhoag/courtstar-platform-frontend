...
function EditCentre(props) {
  ...
  const [imgUrls, setImgUrls] = useState(props.imgList);
  ...
  const [centreForm, setCentreForm] = useState({
    ...
    address: centreDetail.address,
    district: centreDetail.district,
    link: centreDetail.link,
    openTime: centreDetail.openTime,
    closeTime: centreDetail.closeTime,
    pricePerHour: centreDetail.pricePerHour,
    numberOfCourts: centreDetail.numberOfCourts,
    description: centreDetail.description,
