                ...
                <div className="max-w-screen-1440 1440:mx-auto mx-4 py-8 px-12 w-full flex flex-col gap-3">
                    ...
                    <div className="flex justify-between items-center">
                        <div className='text-3xl font-semibold py-5'>
                            ...
                            <p className='text-xl font-semibold py-6'>1. PERSONAL DATA WE COLLECT</p>
                            ...
                            <p className='text-lg font-semibold py-6'>2. THIRD-PARTY PERSONAL DATA PROVIDED BY CUSTOMERS</p>
                            ...
                            <p className='text-lg font-semibold py-6'>3. PURPOSES FOR DATA PROCESSING</p>
                            ...
                            <p className='text-lg font-semibold py-6'>4. SHARING PERSONAL DATA</p>
                            ...
                            <p className='text-lg font-semibold py-6'>5. INTERNATIONAL DATA TRANSFER</p>
                            ...
                            <p className='text-lg font-semibold py-6'>6. DATA STORAGE AND PROCESSING TIME</p>
                            <ul className='font-normal text-base' style={{paddingLeft: '50px', listStyleType: 'disc' }}>
                            ...
                            <p className='text-lg font-semibold py-6'>7. RIGHTS AND OBLIGATIONS OF CUSTOMERS</p>
                            ...
                            <p className='text-lg font-semibold py-6 pb-6'>8. DATA PROTECTION</p>
                            ...
                            <p className='text-lg font-semibold py-6'>9. COOKIES</p>
                            <ul className='font-normal text-base' style={{paddingLeft: '50px', listStyleType: 'disc' }}>
                            ...
                            <p className='text-lg font-semibold py-6'>10. UPDATING THE DATA PROTECTION POLICY</p>
                            <ul className='font-normal text-base' style={{paddingLeft: '50px', listStyleType: 'disc' }}>
